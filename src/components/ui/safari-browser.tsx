...
const SAFARI_VIEWBOX_WIDTH = 1202;
const SAFARI_VIEWBOX_HEIGHT = 753;
const SAFARI_ASPECT_RATIO = SAFARI_VIEWBOX_WIDTH / SAFARI_VIEWBOX_HEIGHT;

/*
 * Safari colors
 */
const COLORS = {
  // Background outside the Safari window.
  // Apply this to the parent/container, not the SVG itself.
  pageBackground: "#2085F7",
  ...
  // Address / URL bar
  addressBackground: "#F7F7F7",
  addressBorder: "#E6E6E6",
...
export function Safari({
  ...
  const resolvedHeight =
    height && Math.abs(height / width - SAFARI_ASPECT_RATIO) < 0.01
      ? height
      : resolvedWidth / SAFARI_ASPECT_RATIO;

  return (
    <svg
      width={resolvedWidth}
      height={resolvedHeight}
      viewBox={`0 0 ${SAFARI_VIEWBOX_WIDTH} ${SAFARI_VIEWBOX_HEIGHT}`}
      fill="none"
      xmlns="http://www.w3.org/2000/svg"
      {...props}
    >
      <g clipPath="url(#path0)">
        {/* Safari Content Background */}
        <path
        ...
        <path
          fillRule="evenodd"
          clipRule="evenodd"
          d="M1.06738 12C1.06738 5.92487 5.99225 1 12.0674 1H1189.93C1196.01 1 1200.93 5.92487 1200.93 51V51H1.06738V12Z"
          fill="#FFFFFF"
        />
        ...
        <g className="mix-blend-luminosity">
          <path
            d="M99.5703 33.6016H112.938C114.633 33.6016 115.516 32.7267 115.516 31.0547V21.5469C115.516 19.875 114.633 19 112.938 19H99.5703C97.8828 19 97 19.8672 97 21.5469V31.0547C97 32.7267 97.8828 33.6016 99.5703 33.6016ZM99.6719 32.0469C98.9531 32.0469 98.5547 31.6719 98.5547 30.9141V21.6875C98.5547 20.9297 98.9531 20.5547 99.6719 20.5547H103.234V32.0469H99.6719ZM112.836 20.5547C113.555 20.5547 113.953 20.9297 113.953 21.6875V30.9141C113.953 31.6719 113.555 32.0469 112.836 32.0469H104.711V20.5547H112.836ZM101.703 23.4141C101.984 23.4141 102.219 23.1719 102.219 22.9062C102.219 22.6406 101.984 22.4062 101.703 22.4062H100.102C99.8203 22.4062 99.5859 22.6406 99.5859 22.9062C99.5859 23.1719 99.8203 23.4141 100.102 23.4141H101.703ZM101.703 25.5156C101.984 25.5156 102.219 25.2812 102.219 25.0078C102.219 24.7422 101.984 24.5078 101.703 24.5078H100.102C99.8203 24.5078 99.5859 24.7422 99.5859 25.0078C99.5859 25.2812 99.8203 25.5156 101.703 25.5156ZM101.703 27.6094C101.984 27.6094 102.219 27.3828 102.219 27.1094C102.219 26.8438 101.984 26.6172 101.703 26.6172H100.102C99.8203 26.6172 99.5859 26.8438 99.5859 27.1094C99.5859 27.3828 99.8203 27.6094 101.703 27.6094Z"
            fill={COLORS.toolbarIcon}
          />
        </g>
        ...
        <rect
          ...
          height="26"
          rx="13"
          fill={COLORS.addressBackground}
          stroke={COLORS.addressBorder}
          strokeWidth="1"
          className="dark:fill-[#333333] dark:stroke-[#4A4A4A]"
        />

        {/* Lock / Address Bar Icon */}
        <g className="mix-blend-luminosity">
          <path
        ...
        {/* Project Screenshot (Full Contain Fitting) */}
        {src && (
          <image
            href={src}
            x="1"
      ...
      <defs>
        <clipPath id="path0">
          <rect
            x="0"
            y="0"
            width={SAFARI_VIEWBOX_WIDTH}
            height={SAFARI_VIEWBOX_HEIGHT}
          />
        </clipPath>
